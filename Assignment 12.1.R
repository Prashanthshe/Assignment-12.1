write.csv(yeast,"C:/Users/prash/Desktop/yeast.csv")

#Ques.1.a. Perform ANOVA test on the discriminant analysis scores of nuclear localization signals of both nuclear
